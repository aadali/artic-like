...
2. 在任意目录下进行分析
   ...
   ```shell
   snakemake consensus --cores 16 --SnakefileNGS /the/path/to/artic-like/Snakefile  --config input_fastq=/the/path/to/input_fastq
   
   snakemake annotate --cores 16 --SnakefileNGS /the/path/to/artic-like/Snakefile  --config input_fastq=/the/path/to/input_fastq
   
   snakemake report --cores 16 --SnakefileNGS /the/path/to/artic-like/Snakefile  --config input_fastq=/the/path/to/input_fastq
